...
shinyUI(
  ...
  # Color of header.
  skin = 'green',
  # Header Title and size.
  dashboardHeader(title = "Top 20 World's Economies",
                  titleWidth = 300),
  # Sidebar Settings.
  dashboardSidebar(
    # Sidebar size.
    width = 300,
    # Sidebar name, subtitle and image.
    ...
    sidebarMenu(
      ...
      # Sidebar itens(variables, names, icons)
